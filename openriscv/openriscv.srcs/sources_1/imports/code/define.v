...
`define FUNCT7_MULDIV               7'b0000001      //M扩展的funct7
`define EXE_MUL                     3'b000          //乘法，返回低32位
`define EXE_MULH                    3'b001          //有符号乘法，返回高32位
`define EXE_MULHSU                  3'b010          //有符号×无符号乘法，返回高32位
`define EXE_MULHU                   3'b011          //无符号乘法，返回高32位
`define EXE_DIV                     3'b100          //有符号除法
`define EXE_DIVU                    3'b101          //无符号除法
