...
REM
REM Generated by Vivado on Wed Dec 24 11:10:01 +0800 2025
...
echo "xvlog --incr --relax -prj openriscv_min_sopc_tb_vlog.prj"
call xvlog  --incr --relax -prj openriscv_min_sopc_tb_vlog.prj -log xvlog.log
